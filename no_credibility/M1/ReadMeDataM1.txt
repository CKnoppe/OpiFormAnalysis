...
M1: MODEL VERSION 1
    • Matching: sentiments bound alpha; opinion difference; no credibility score (no impact of kappa)
    • Opinion update: Standard model (theta; no impact of gamma)

Folder's Names: [K0G0T1][A300][T1000][M:[0.5:0.95]][s: values from 5 to 95]-[n8]

K0: no credibility in matching
G0: no credibility in the opinion update
T1: standard model with tolerance theta in the opinion exchange
